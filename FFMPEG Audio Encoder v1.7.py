...
root = Tk()
root.title("FFMPEG Audio Encoder 1.6")
...
def file_input():
    ...
    if not VideoInput:
        ...
        ffprobeinfo2 = subprocess.Popen(ffprobe + " " + VideoInputQuoted + " " + ffprobecommand2, universal_newlines=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, stdin=subprocess.PIPE)
