...
The encoder reference page is generated by the docs build rather than committed, so there is nothing to keep in sync by hand - see [working on the docs](docs.md#the-generated-page).
