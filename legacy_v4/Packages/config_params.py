...
def create_config_params():
    """function to create parameters at launch"""

    config_file = "Runtime/config.ini"  # Creates (if config doesn't exist) and defines location of config.ini
    config = ConfigParser()
    ...
    if not config.has_option(
        "save_window_locations", "window location settings position"
    ):
    ...
    if not config.has_option(
        "save_window_locations", "audio window - e-ac3 - position"
    ):
    ...
    if not config.has_option(
        "save_window_locations", "audio window - fdk-aac - position"
    ):
    ...
    if not config.has_option(
        "save_window_locations", "audio window - view streams - position"
    ):
        config.set(
            "save_window_locations", "audio window - view streams - position", ""
        )
    ...
    if not config_profile.has_option("FFMPEG AAC - SETTINGS", "custom_command_line"):
    ...
    if not config_profile.has_option("FFMPEG AC3 - SETTINGS", "custom_command_line"):
    ...
    if not config_profile.has_option("FFMPEG DTS - SETTINGS", "custom_command_line"):
    ...
    if not config_profile.has_option(
        "FFMPEG E-AC3 - SETTINGS", "e-ac3_per_frame_metadata"
    ):
        config_profile.set(
    ...
    if not config_profile.has_option(
        "FFMPEG E-AC3 - SETTINGS", "e-ac3_original_bitstream"
    ):
    ...
    if not config_profile.has_option(
        "FFMPEG E-AC3 - SETTINGS", "e-ac3_lt_rt_center_mix"
    ):
        config_profile.set("FFMPEG E-AC3 - SETTINGS", "e-ac3_lt_rt_center_mix", "-1")
    if not config_profile.has_option(
        "FFMPEG E-AC3 - SETTINGS", "e-ac3_lt_rt_surround_mix"
    ):
        config_profile.set("FFMPEG E-AC3 - SETTINGS", "e-ac3_lt_rt_surround_mix", "-1")
    if not config_profile.has_option(
        "FFMPEG E-AC3 - SETTINGS", "e-ac3_lo_ro_center_mix"
    ):
        config_profile.set("FFMPEG E-AC3 - SETTINGS", "e-ac3_lo_ro_center_mix", "-1")
    if not config_profile.has_option(
        "FFMPEG E-AC3 - SETTINGS", "e-ac3_lo_ro_surround_mix"
    ):
        config_profile.set("FFMPEG E-AC3 - SETTINGS", "e-ac3_lo_ro_surround_mix", "-1")
    if not config_profile.has_option(
        "FFMPEG E-AC3 - SETTINGS", "e-ac3_dolby_surround_ex_mode"
    ):
        config_profile.set(
            "FFMPEG E-AC3 - SETTINGS", "e-ac3_dolby_surround_ex_mode", "Default"
        )
    if not config_profile.has_option(
        "FFMPEG E-AC3 - SETTINGS", "e-ac3_dolby_headphone_mode"
    ):
        config_profile.set(
            "FFMPEG E-AC3 - SETTINGS", "e-ac3_dolby_headphone_mode", "Default"
        )
    if not config_profile.has_option(
        "FFMPEG E-AC3 - SETTINGS", "e-ac3_a_d_converter_type"
    ):
        config_profile.set(
            "FFMPEG E-AC3 - SETTINGS", "e-ac3_a_d_converter_type", "Default"
        )
    if not config_profile.has_option(
        "FFMPEG E-AC3 - SETTINGS", "e-ac3_stereo_rematrixing"
    ):
        config_profile.set(
            "FFMPEG E-AC3 - SETTINGS", "e-ac3_dolby_stereo_rematrixing", "Default"
        )
    if not config_profile.has_option(
        "FFMPEG E-AC3 - SETTINGS", "e-ac3_channel_coupling"
    ):
    ...
    if not config_profile.has_option("FFMPEG E-AC3 - SETTINGS", "custom_command_line"):
    ...
    if not config_profile.has_option("FFMPEG Opus - SETTINGS", "custom_command_line"):
    ...
    if not config_profile.has_option("FDK-AAC - SETTINGS", "custom_command_line"):
        config_profile.set("FDK-AAC - SETTINGS", "custom_command_line", "")
    if not config_profile.has_option("FDK-AAC - SETTINGS", "fdk_custom_command_line"):
    ...
    if not config_profile.has_option("FFMPEG MP3 - SETTINGS", "custom_command_line"):
    ...
    if not config_profile.has_option("FFMPEG QAAC - SETTINGS", "custom_command_line"):
    ...
    if not config_profile.has_option("FFMPEG FLAC - SETTINGS", "custom_command_line"):
    ...
    if not config_profile.has_option(
        "FFMPEG ALAC - SETTINGS", "alac_min_prediction_order"
    ):
        config_profile.set("FFMPEG ALAC - SETTINGS", "alac_min_prediction_order", "4")
    if not config_profile.has_option(
        "FFMPEG ALAC - SETTINGS", "alac_max_prediction_order"
    ):
        config_profile.set("FFMPEG ALAC - SETTINGS", "alac_max_prediction_order", "6")
    if not config_profile.has_option("FFMPEG ALAC - SETTINGS", "custom_command_line"):
    ...
    try:
        ...
        messagebox.showinfo(
            title="Error",
            message="Could Not Write to profiles.ini file, delete and try again",
        )
    # Profile Config --------------------------------------------------------------------------------------------------
