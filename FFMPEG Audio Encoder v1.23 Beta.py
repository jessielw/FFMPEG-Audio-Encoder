...
root = Tk()
root.title("FFMPEG Audio Encoder Alpha Beta 1.23")
...
def startaudiojob():
    ...
    if encoder.get() == "AC3":
        if acodec_channel.get() == 'Original':
            commands = ffmpeg + " -analyzeduration 100M -probesize 50M -i " + VideoInputQuoted + " " + acodec_stream_choices[acodec_stream.get()] + " -c:a " + encoder_dropdownmenu_choices[encoder.get()] + " -b:a " + acodec_bitrate.get() + " -sn -vn " + VideoOutputQuoted + " -hide_banner -v error -stats"
            subprocess.Popen(commands)
        else:
            commands = ffmpeg + " -analyzeduration 100M -probesize 50M -i " + VideoInputQuoted + " " + acodec_stream_choices[acodec_stream.get()] + " -c:a " + encoder_dropdownmenu_choices[encoder.get()] + " -b:a " + acodec_bitrate.get() + " -ac " + acodec_channel_choices[acodec_channel.get()] + " -sn -vn " + VideoOutputQuoted + " -hide_banner -v error -stats"
            subprocess.Popen(commands)

    if encoder.get() == "AAC":
        if acodec_channel.get() == 'Original':
            commands = ffmpeg + " -analyzeduration 100M -probesize 50M -i " + VideoInputQuoted + " " + acodec_stream_choices[acodec_stream.get()] + " -c:a " + encoder_dropdownmenu_choices[encoder.get()] + " -b:a " + acodec_bitrate.get() + " -sn -vn " + VideoOutput + " -hide_banner -v error -stats"
            subprocess.Popen(commands)
        else:
            commands = ffmpeg + " -analyzeduration 100M -probesize 50M -i " + VideoInputQuoted + " " + acodec_stream_choices[acodec_stream.get()] + " -c:a " + encoder_dropdownmenu_choices[encoder.get()] + " -b:a " + acodec_bitrate.get() + " -ac " + acodec_channel_choices[acodec_channel.get()] + " -sn -vn " + VideoOutputQuoted + " -hide_banner -v error -stats"
            subprocess.Popen(commands)
        ...
        commands = ffmpeg + " -analyzeduration 100M -probesize 50M -i " + VideoInputQuoted + " " + acodec_stream_choices[acodec_stream.get()] + " " + dts_settings_choices[dts_settings.get()] + " -sn -vn " + VideoOutputQuoted + " -hide_banner -v error -stats"
        print(commands)
        subprocess.Popen(commands)
