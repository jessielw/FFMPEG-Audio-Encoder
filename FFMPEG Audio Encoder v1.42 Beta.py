...
def openaudiowindow():
    ...
    if encoder.get() == "AC3":
        ...
        def abitrate_menu_hover(e):
            abitrate_menu["bg"] = "grey"
            abitrate_menu["activebackground"] = "grey"
        def abitrate_menu_hover_leave(e):
            abitrate_menu["bg"] = "#23272A"
        ...
        abitrate_menu_label = Label(audio_window, text="Bitrate :", background="#434547", foreground="white")
        abitrate_menu_label.grid(row=0, column=2, columnspan=1, padx=10, pady=3, sticky=W+E)
        abitrate_menu = OptionMenu(audio_window, acodec_bitrate, *acodec_bitrate_choices.keys())
        abitrate_menu.config(background="#23272A", foreground="white", highlightthickness=1)
        abitrate_menu.grid(row=1, column=2, columnspan=1, padx=10, pady=3, sticky=N+S+W+E)
        abitrate_menu["menu"].configure(activebackground="dim grey")
        abitrate_menu.bind("<Enter>", abitrate_menu_hover)
        abitrate_menu.bind("<Leave>", abitrate_menu_hover_leave)
    ...
    # AAC Window -----------------------
        ...
        apply_button.grid(row=3, column=2, columnspan=1, padx=10, pady=10, sticky=N+S+W+E)
        apply_button.bind("<Enter>", apply_button_hover)
        apply_button.bind("<Leave>", apply_button_hover_leave)
        ...
        abitrate_menu_label.grid(row=0, column=2, columnspan=1, padx=5, pady=5, sticky=N+S+W+E)
        abitrate_menu = OptionMenu(audio_window, acodec_bitrate, *acodec_bitrate_choices)
        abitrate_menu.grid(row=1, column=2, columnspan=1, padx=5, pady=5, sticky=N+S+W+E)
        ...
        achannel_menu_label.grid(row=0, column=1, columnspan=1, padx=5, pady=5, sticky=N+S+W+E)
        achannel_menu = OptionMenu(audio_window, acodec_channel, *acodec_channel_choices.keys())
        achannel_menu.grid(row=1, column=1, columnspan=1, padx=5, pady=10, sticky=N+S+W+E)
        ...
        acodec_stream_label.grid(row=0, column=0, columnspan=1, padx=5, pady=5, sticky=N+S+W+E)
        acodec_stream_menu = OptionMenu(audio_window, acodec_stream, *acodec_stream_choices.keys())
        acodec_stream_menu.grid(row=1, column=0, columnspan=1, padx=5, pady=5, sticky=N+S+W+E)
        ...
        acodec_gain_label.grid(row=2, column=0, columnspan=1, padx=5, pady=5, sticky=N+S+W+E)
        acodec_gain_menu = OptionMenu(audio_window, acodec_gain, *acodec_gain_choices.keys())
        acodec_gain_menu.grid(row=3, column=0, columnspan=1, padx=5, pady=5, sticky=N+S+W+E)
...
def startaudiojob():
    ...
    # Commands------------------------------------
    if encoder.get() == "AC3":
        commands = ffmpeg + " -analyzeduration 100M -probesize 50M -i " + VideoInputQuoted + acodec_stream_choices[
            acodec_stream.get()] + encoder_dropdownmenu_choices[encoder.get()] + acodec_bitrate_choices[
                       acodec_bitrate.get()] + acodec_channel_choices[acodec_channel.get()] + acodec_gain_choices[
