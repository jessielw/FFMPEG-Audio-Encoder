...
root = Tk()
root.title("FFMPEG Audio Encoder Beta 1.3")
...
def file_input():
    ...
    if not VideoInput:
        ...
        ffprobeinfo = subprocess.Popen(ffprobe + " " + VideoInputQuoted + " " + ffprobecommand, universal_newlines=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
